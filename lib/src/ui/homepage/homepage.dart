...
import 'package:elderlyapp/src/ui/medicine_details/medicine_details.dart';
import 'package:elderlyapp/src/ui/new_entry/new_entry.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Reminders',textAlign: TextAlign.center,)),
        elevation: 0.0,
      ),
      body: Container(
